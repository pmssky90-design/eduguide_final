...
body{margin:0;font-family:'Noto Sans KR',Arial,sans-serif;line-height:1.8;background:var(--bg);color:var(--ink);word-break:keep-all}
a{color:inherit}
...
.prose li{position:relative;padding:.72rem .85rem .72rem 2.25rem;border:1px solid var(--line);border-radius:8px;background:#fbfdff;color:#40506a;font-size:1.0625rem;line-height:1.85}
...
.home-section p{margin:.35rem 0 1rem;color:#48566d;font-size:1.0625rem;line-height:1.85}
...
.home-school-cities{display:grid;gap:.8rem;margin-top:1rem}
.home-school-city{border:1px solid var(--line);border-radius:10px;background:#fff;overflow:hidden}
.home-school-city summary{display:flex;align-items:center;justify-content:space-between;gap:1rem;min-height:54px;padding:.8rem 1rem;color:#26374f;font-weight:800;cursor:pointer;list-style-position:inside}
.home-school-city summary:hover{background:var(--soft);color:var(--accent)}
.home-school-count{color:var(--muted);font-size:.86rem;white-space:nowrap}
.home-school-districts{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:.8rem;padding:0 1rem 1rem}
.home-school-group{min-width:0;padding:.85rem;border:1px solid var(--line);border-radius:8px;background:#fbfdff}
.home-school-group h3{margin:0 0 .65rem;color:#34445d;font-size:.96rem;line-height:1.35}
.home-school-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:.5rem;margin:0;padding:0;list-style:none}
.home-school-grid a{display:flex;align-items:center;min-width:0;min-height:44px;padding:.58rem .68rem;border:1px solid var(--line);border-radius:7px;background:#fff;color:#26374f;text-decoration:none;font-size:.9rem;font-weight:700;line-height:1.4;overflow-wrap:anywhere;word-break:keep-all}
.home-school-grid a:hover{border-color:#a9c7f4;background:var(--soft);color:var(--accent)}
.home-copy{background:#fff}
.home-copy p{max-width:860px;margin:.8rem 0 0;color:#42516a}
...
@media(max-width:640px){.container{width:100%;max-width:none;padding-left:12px;padding-right:12px}.page-layout{width:100%;padding:.85rem 0 1.7rem}.page-card{width:100%;max-width:none;padding:18px 14px;border-radius:8px}.nav-wrap{gap:.6rem;min-height:56px}.site-nav a{padding:.38rem .52rem;font-size:.9rem}.home-hero{padding:0 0 .9rem}.home-hero-media{margin:0 0 1.1rem}.home-hero-image{width:100%;max-height:250px;object-fit:cover;border-radius:14px}.home-hero h2{font-size:1.34rem;line-height:1.35}.home-section{margin:1rem 0 0;padding:1rem}.home-section h2,.prose h2{font-size:1.75rem;line-height:1.3}.home-region-group h3,.prose h3{font-size:1.3rem;line-height:1.32}.home-section p,.home-copy p,.prose p,.prose li,.related-links a{font-size:1.0625rem;line-height:1.85}.lead{max-width:100%;padding:22px;border-left-width:4px;font-size:1.125rem;line-height:1.9}.home-link-grid{grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.home-region-group .home-link-grid{grid-template-columns:1fr}.home-link-grid a{min-height:44px;padding:.68rem .72rem;font-size:.95rem;line-height:1.35}.fixed-images{gap:16px;margin:20px 0}.page-fixed-image{display:block;width:100%;max-width:100%;height:auto;margin:20px auto;border-radius:14px}.related-links{max-width:none;margin-top:1.5rem}.prose ul{gap:.45rem}.prose li{padding:.65rem .75rem .65rem 2rem}.related-links a{min-height:44px}}
@media(max-width:640px){.home-school-districts{grid-template-columns:1fr;padding:0 .75rem .75rem}.home-school-city summary{padding:.75rem}.home-school-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}
@media(max-width:420px){.home-link-grid{grid-template-columns:1fr}h1{font-size:2.375rem;line-height:1.25}.home-section h2,.prose h2{font-size:1.68rem}}
@media(max-width:420px){.home-school-grid{grid-template-columns:1fr}}
.mobile-cta{display:none}
@media(max-width:768px){body{padding-bottom:calc(100px + env(safe-area-inset-bottom,0px))}.mobile-cta{position:fixed;z-index:1000;left:50%;bottom:calc(10px + env(safe-area-inset-bottom,0px));display:grid;grid-template-columns:1fr 1fr;width:calc(100% - 20px);max-width:620px;height:68px;overflow:hidden;border-radius:16px;box-shadow:0 12px 32px rgba(24,34,48,.28);transform:translateX(-50%)}.mobile-cta a{display:flex;align-items:center;justify-content:center;gap:.55rem;min-width:0;min-height:68px;color:#fff;text-decoration:none;font-size:19px;font-weight:800;line-height:1;letter-spacing:-.01em;-webkit-tap-highlight-color:transparent}.mobile-cta-phone{background:#14733c}.mobile-cta-sms{background:#e65324}.mobile-cta-icon{font-size:22px;line-height:1}.mobile-cta a:focus-visible{outline:3px solid #fff;outline-offset:-5px}}
""".strip()

MOBILE_CTA_HTML = '''<nav class="mobile-cta" aria-label="빠른 상담"><a class="mobile-cta-phone" href="tel:01049479030"><span class="mobile-cta-icon" aria-hidden="true">☎</span><span>전화하기</span></a><a class="mobile-cta-sms" href="sms:01049479030"><span class="mobile-cta-icon" aria-hidden="true">✉</span><span>문자하기</span></a></nav>'''
